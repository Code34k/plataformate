...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-04-2018 a las 09:05:33
...
CREATE TABLE `posts` (
  ...
  `url` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `resumen` mediumtext COLLATE utf8mb4_unicode_ci,
...
INSERT INTO `posts` (`id`, `ngrupo`, `url`, `resumen`, `representante`, `body`, `municipio_id`, `created_at`, `updated_at`) VALUES
(4, 'asopromet', 'asopromet', 'dfgdfgdsf', 'dfgfdgdf', '<p>fsdgdsfgdh</p>', 1, '2018-04-16 04:00:06', '2018-04-16 04:00:56');
...
(1, 'carlos', 'carlosaudiovisual2015@gmail.com', '$2y$10$sE2GoaS8fm4gbxsFn3NpqezGf8b1UovoR00gvNPQD7lSVYr1DIDoW', NULL, '2018-03-22 23:33:11', '2018-03-22 23:33:11'),
